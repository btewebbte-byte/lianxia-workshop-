...
const translations: Translations = {
  ...
  'contact.wechat.title': { zh: '电报咨询', en: 'Telegram', ja: '텔레グラム相談', th: 'แชท Telegram', 'zh-TW': '電報諮詢', ko: '텔레그램 상담' },
  'contact.wechat.desc': { zh: '添加电报好友，直接与AI大龙虾沟通', en: 'Add Telegram friend, chat directly with AI Lobster', ja: '텔레그램追加、AIロブスターと直接やり取り', th: 'เพิ่มเพื่อน Telegram ติดต่อกุ้งล็อบ AI โดยตรง', 'zh-TW': '新增電報好友，直接與AI大龍蝦溝通', ko: '텔레그램 친구 추가, AI 랍스터와 직접 대화' },
